...
export const maibotFeedbackSurvey: SurveyConfig = {
  ...
  version: '1.0.0',
  title: '千惠使用体验反馈问卷',
  description: '感谢您使用千惠！您的反馈将帮助我们打造更好的 AI 伙伴。',
  questions: [
    {
      id: 'maibot_version',
      type: 'text',
  ...
  settings: {
    allowMultiple: false,
    thankYouMessage: '感谢你的反馈！你的意见对千惠的成长非常重要，我们会认真考虑每一条建议。',
  },
}
